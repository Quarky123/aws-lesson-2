...
We expect a formatted and complete Jupyter Notebook by end of class on Thursday Oct 15th, 2020, which accomplishes the following:
...
## Necessary Deliverables / Submission
 ...
 Materials must be presented in a Jupyter Notebook stored within a repository on your personal (*not* GA) GitHub. Please submit a link to this repository by the due date ([submission link](https://forms.gle/jDGkaT5SEVA5Y9qNA)).
